...
class IngestionRunStatus(StrEnum):
    """Lifecycle states for an IngestionRun.

    RUNNING  — the run is open, claims are being written.
    FINISHED — the run completed successfully.
    FAILED   — the run terminated with an error; partial claims may exist.
    """
...
class OutboxEventType(StrEnum):
    ...
    ECHO_CROSSREF_REQUESTED = "ECHO_CROSSREF_REQUESTED"
