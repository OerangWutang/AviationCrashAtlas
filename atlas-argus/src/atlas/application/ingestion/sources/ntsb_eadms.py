...
def _select_primary_aircraft(
    ...
    the raw payload; per-aircraft claim fan-out is a documented v1.1 extension.
    """
    if not aircraft_rows:
        return None
    return min(aircraft_rows, key=lambda r: _to_int(r.get("Aircraft_Key")) or 0)
